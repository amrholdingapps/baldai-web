    ...
    <div className="flex justify-center items-center min-h-screen pb-4">
      <div className="rounded-lg w-full max-w-2xl">
        ...
        <p className="text-foreground/90 mb-8">
          These Terms and Conditions outline the rules and regulations for the use of Hairloss AI's
          Application. By accessing this application, we assume you accept these Terms and
          Conditions in full. Do not continue to use Hairloss AI's Application if you do not accept
        ...
        <p className="text-foreground/90 mb-8">
          ...
          conditions. These definitions shall have the same meaning regardless of whether they
          appear in singular or in plural.
        </p>

        <h2 className="text-foreground text-2xl font-regular mb-2">Definitions</h2>
        <ul className="list-none list-inside mb-8 text-foreground/90 space-y-2">
          <li>
            <span className="font-semibold">Application</span> – refers to the software program
            provided by the Company, named Hairloss AI, that You downloaded on any electronic
            device.
          </li>
          <li>
            <span className="font-semibold">Application Store</span> – refers to the digital
            distribution service operated by Apple Inc. (Apple App Store) or Google Inc. (Google
            Play Store) where the Application has been downloaded.
          </li>
          <li>
            <span className="font-semibold">Affiliate</span> – means an entity that controls, is
            controlled by, or is under common control with a party, where "control" refers to
            ownership of 50% or more of the shares, equity interest, or other securities entitled to
            vote for the election of directors or other managing authority.
          </li>
          <li>
            <span className="font-semibold">Country</span> – refers to Ontario, Canada.
          </li>
          <li>
            <span className="font-semibold">Company</span> – (referred to as "the Company", "We",
            "Us", or "Our" in this Agreement) refers to Hairloss AI.
          </li>
          <li>
            <span className="font-semibold">Device</span> – refers to any device that can access the
            Service, such as a computer, cellphone, or digital tablet.
          </li>
          <li>
            <span className="font-semibold">Service</span> – refers to the Application.
          </li>
          <li>
            <span className="font-semibold">Terms and Conditions</span> – (also referred to as
            "Terms") mean these Terms and Conditions that constitute the entire agreement between
            You and the Company regarding the use of the Service.
          </li>
          <li>
            <span className="font-semibold">Third-party Social Media Service</span> – refers to any
            services or content (including data, information, products, or services) provided by a
            third party that may be displayed, included, or made available by the Service.
          </li>
          <li>
            <span className="font-semibold">You</span> – refers to the individual accessing or using
            the Service, or the company or other legal entity on behalf of which such individual is
            accessing or using the Service, as applicable.
          </li>
        </ul>

        <h2 className="text-foreground text-2xl font-regular mb-4">Acknowledgment</h2>
        <p className="text-foreground/90 mb-8">
          These Terms and Conditions govern the use of this Service and constitute the agreement
          that operates between You and the Company. They set out the rights and obligations of all
        ...
        <p className="text-foreground/90 mb-8">
          ...
          You disagree with any part of these Terms, You may not access the Service. You represent
          that you are over the age of 17. The Company does not permit those under 17 to use the
          Service.
        </p>
        <p className="text-foreground/90 mb-8">
          ...
          information when You use the Application or the Website and informs You about Your privacy
          rights and how the law protects You. Please read Our Privacy Policy carefully before using
          Our Service.
        </p>

        <h2 className="text-foreground text-2xl font-regular mb-4">In-App Subscriptions</h2>
        <p className="text-foreground/90 mb-8">
          The Application offers in-app subscriptions that provide access to premium features and
          content. These subscriptions may be available on a weekly, monthly, or annual basis.
          Payment will be charged to Your Apple ID or Google Play account upon confirmation of
          purchase. Subscriptions automatically renew unless auto-renew is turned off at least 24
          hours before the end of the current period. You can manage or turn off auto-renewal in
          Your account settings after purchase.
        </p>
        <p className="text-foreground/90 mb-8">
          By purchasing an in-app subscription, You agree to be bound by these Terms and any
          additional terms and conditions associated with the specific subscription.
        </p>
        ...
        <h2 className="text-foreground text-2xl font-regular mb-4">Termination</h2>
        <p className="text-foreground/90 mb-8">
        ...
        <h2 className="text-foreground text-2xl font-regular mb-4">Limitation of Liability</h2>
        <p className="text-foreground/90 mb-8">
        ...
        <p className="text-foreground/90 mb-8">
          ...
          other information, business interruption, personal injury, or loss of privacy arising out
          of or in any way related to the use of or inability to use the Service, third-party
        ...
        <p className="text-foreground/90 mb-8">
          ...
          Company, on its own behalf and on behalf of its Affiliates and their respective licensors
          and service providers, expressly disclaims all warranties, whether express, implied,
        ...
        <p className="text-foreground/90 mb-8">
          ...
          malware, time bombs, or other harmful components.
        </p>
        <p className="text-foreground/90 mb-8">
        ...
        <h2 className="text-foreground text-2xl font-regular mb-4">Governing Law</h2>
        <p className="text-foreground/90 mb-8">
          The laws of Ontario, Canada, excluding its conflicts of law rules, shall govern these
        ...
        <h2 className="text-foreground text-2xl font-regular mb-4">Disputes Resolution</h2>
        <p className="text-foreground/90 mb-8">
        ...
        <h2 className="text-foreground text-2xl font-regular mb-4">Severability and Waiver</h2>
        <p className="text-foreground/90 mb-8">
        ...
        <p className="text-foreground/90 mb-8">
          ...
          obligation under these Terms shall not affect a party's ability to exercise such a right
          or require such performance at any time thereafter, nor shall the waiver of a breach
          constitute a waiver of any subsequent breach.
        </p>

        <h2 className="text-foreground text-2xl font-regular mb-4">Translation Interpretation</h2>
        <p className="text-foreground/90 mb-8">
        ...
        <p className="text-foreground/90 mb-8">
          ...
          days' notice before any new terms take effect. What constitutes a material change will be
