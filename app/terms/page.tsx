      ...
      <div className="flex justify-center min-h-screen py-8 px-4">
        <div className="rounded-lg w-full max-w-2xl">
          ...
          <p className="text-foreground/90 mb-8">
            These Terms and Conditions outline the rules and regulations for the use of Hairloss
            AI's Application. By accessing this application, we assume you accept these Terms and
            Conditions in full. Do not continue to use Hairloss AI's Application if you do not
          ...
          <ul className="list-none list-inside mb-8 text-foreground/90 space-y-2">
            ...
            <li>
              <span className="font-semibold">Device</span> – refers to any device that can access
              the Service, such as a computer, cellphone, or digital tablet.
            </li>
            <li>
            ...
            <li>
              <span className="font-semibold">Third-party Social Media Service</span> – refers to
              any services or content (including data, information, products, or services) provided
              by a third party that may be displayed, included, or made available by the Service.
            </li>
            <li>
              <span className="font-semibold">You</span> – refers to the individual accessing or
          ...
          <p className="text-foreground/90 mb-8">
            ...
            that operates between You and the Company. They set out the rights and obligations of
            all users regarding the use of the Service.
          </p>
          <p className="text-foreground/90 mb-8">
            Your access to and use of the Service is conditioned on Your acceptance of and
            compliance with these Terms and Conditions. These Terms apply to all visitors, users,
            and others who access or use the Service.
          </p>
          <p className="text-foreground/90 mb-8">
            By accessing or using the Service, You agree to be bound by these Terms and Conditions.
            If You disagree with any part of these Terms, You may not access the Service. You
            represent that you are over the age of 17. The Company does not permit those under 17 to
            use the Service.
          </p>
          <p className="text-foreground/90 mb-8">
            ...
            information when You use the Application or the Website and informs You about Your
          ...
          <p className="text-foreground/90 mb-8">
            ...
            other information, business interruption, personal injury, or loss of privacy arising
          ...
          <p className="text-foreground/90 mb-8">
            ...
            law, the Company, on its own behalf and on behalf of its Affiliates and their respective
          ...
          <p className="text-foreground/90 mb-8">
            ...
            an obligation under these Terms shall not affect a party's ability to exercise such a
          ...
          <p className="text-foreground/90 mb-8">
            ...
            days' notice before any new terms take effect. What constitutes a material change will
